    ...
    def delete_work_order(self):
        ...
        for work_order in self.work_orders:
            if work_order.work_order_id == deletion_id:
                ...
                print("Are you sure you want to delete this work order?")
                confirmation = int(input("Press 1 to confirm or 2 to exit: "))
                if confirmation == 1:
...
def main():
    ...
    while True:
        ...
        print("6. Create new work order")
        print("7. View in progress work orders")
        print("8. View completed work orders")
        print("9. Logout")
